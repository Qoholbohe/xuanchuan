jQuery(document).ready(function($) {
    ...
    $('#province').change(function() {
        ...
        var cityItem = '<option value="0">请选择城市</option>';
    ...
    $('.submit').click(function() {
        ...
        if (nickname.length < 1  || pwd.length < 1) {
            alert('你的清单信息填写不完整');
            return;
        }

        if(province == 0 || province.length < 1){
        	alert('请填写你所在的省份');
            return;
        }
        if(city == 0 || city.length < 1){
        	alert('请填写你所在的城市');
            return;
        }
        if(!sex){
